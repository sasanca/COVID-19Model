...
savefig(figure(1),'./fig/forecast_model_spain')
hgexport(figure(1),'./eps/forecast_model_spain')
saveas(figure(1),'./png/forecast_model_spain.png')

savefig(figure(2),'./fig/forecast_peak_spain')
hgexport(figure(2),'./eps/forecast_peak_spain')
saveas(figure(2),'./png/forecast_peak_spain.png')
